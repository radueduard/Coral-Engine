...
//
// namespace Coral::GUI {
// 	class FileButton final : public ReadOnlyTemplate<std::filesystem::path> {
// 	public:
...
// 				m_iconTextures[type] = Graphics::Texture::Builder()
//                     .Name(type)
...
// 		}
//
// 		Element *Build(const std::filesystem::path &data) override {
...
//
// 	private:
// 		std::unordered_map<std::string, std::unique_ptr<Graphics::Texture>> m_iconTextures;
