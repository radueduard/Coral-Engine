...
struct ImGuiContext
{
    ...
    ImGuiID                 DebugHookIdInfo;                    // Will call re_core hooks: DebugHookIdInfo() from GetID functions, used by ID Stack Tool [next HoveredId/ActiveId to not pull in an extra cache-line]
...
//#endif
    ...
    IMGUI_API bool          ItemHoverable(const ImRect& bb, ImGuiID id, ImGuiItemFlags item_flags, bool dbg = false);
    ...
    IMGUI_API bool          ButtonBehavior(const ImRect& bb, ImGuiID id, bool* out_hovered, bool* out_held, ImGuiButtonFlags flags = 0, bool dbg = false);
